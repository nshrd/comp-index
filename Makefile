...
help:
	...
	@echo "  fix-dns          - Проверка и исправление DNS записей"
	@echo "  fix-nginx        - Исправление nginx конфигурации"
...
fix-dns:
	...
	@chmod +x scripts/fix_dns_ip.sh
	@./scripts/fix_dns_ip.sh

# Исправление nginx конфигурации
fix-nginx:
	@echo "🔧 Исправление nginx конфигурации..."
	@chmod +x scripts/fix_nginx_config.sh
