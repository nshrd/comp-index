...
class CoinglassClient:
    ...
    def get_available_symbols(self) -> List[Dict[str, str]]:
        ...
        current_time = time.time()
        if (
            self._symbols_cache["data"]
            and (current_time - self._symbols_cache["last_update"])
            < self._symbols_cache["cache_duration"]
        ):
        ...
        popular_symbols = [
            ...
            {"symbol": "ATOMUSDT", "name": "Cosmos", "description": "Cosmos / USDT"},
            {
                ...
                "description": "Ethereum Classic / USDT",
            },
            ...
            {"symbol": "VETUSDT", "name": "VeChain", "description": "VeChain / USDT"},
            {
                ...
                "description": "Internet Computer / USDT",
            },
            ...
            },
            {
                "symbol": "SUSHIUSDT",
                "name": "SushiSwap",
                "description": "SushiSwap / USDT",
            },
            {
                "symbol": "YFIUSDT",
                "name": "Yearn.finance",
                "description": "Yearn.finance / USDT",
            },
            {
                "symbol": "SNXUSDT",
                "name": "Synthetix",
                "description": "Synthetix / USDT",
            },
        ]
                        ...
                        result.append(
                            {
                                ...
                                "volume": float(
                                    candle.get("volume_usd", candle.get("volume", 0))
                                ),
                            }
                        )
    ...
    def get_btc_ohlcv(
        self, days: int = 365, interval: str = "4h"
    ) -> Optional[List[Dict]]:
        """
